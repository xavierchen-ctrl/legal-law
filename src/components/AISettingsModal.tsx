        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold text-gray-800">🔑 設定個人 API Key</h2>
                    <button onClick={onClose} className="text-gray-500 hover:text-gray-700">✕</button>
                </div>

                <p className="text-sm text-gray-500 mb-4">
                    您可以輸入個人的 Google Gemini API Key。設定后，手動執行的掃描與分析將使用您的配額，不會佔用系統共用額度。
                </p>
                ...
                <div className="mb-4">
                    ...
                    <div className="mt-1 text-xs text-gray-400">
                        還沒有 Key？ <a href="https://aistudio.google.com/app/apikey" target="_blank" className="text-blue-500 underline">前往 Google AI Studio 申請</a>
                    </div>
                </div>
